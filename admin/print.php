...
@page { margin: 0; }
	...
	while($row=mysqli_fetch_array($re))
	{
		...
		$days = $row['noofdays'];
									...
									if($bed=="Single")
									{
										$type_of_bed = $type_of_room * 1;
									}
									else if($bed=="Double")
									{
										$type_of_bed = $type_of_room * 2;
									}
									else if($bed=="Triple")
									{
										$type_of_bed = $type_of_room * 3;
									}
									else if($bed=="Quad")
									{
										$type_of_bed = $type_of_room * 4;
									}
									else if($bed=="None")
									{
										$type_of_bed = $type_of_room * 0;
									}
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>Ankara Waterfront,</p>
				<p>Bolgoda Road,<br>Panadura,<br>Sri Lanka.</p>
				<p>(+94) 65 222 22 22</p>
			</address>
			<span><h1 style="color:red">ANKARA WATERFRONT</h1></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@ankara.com || Web :- www.ankara.com || Phone :- +94 65 222 22 22 </p>
			</div>
		</aside>
	</body>
</html>
